...
{
    public OperationResult Organize(AlphabeticalOrganizerRule rule, TEntity[] entities)
    {
        throw new NotImplementedException();
    }

    public OperationResult Cleanup(AlphabeticalOrganizerRule rule, TEntity[] entities)
    {
        throw new NotImplementedException();
    }
}